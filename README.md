  ...
  This is a Node.js CLI application that uses `inquirer` receive input about employees and generate an HTML page that shows summaries for each person. This repo comes complete with unit tests (using `jest`) for each class. 
